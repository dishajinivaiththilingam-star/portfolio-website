const experience = [
  {
    ...
    tags: ["React.js", "HTML", "CSS", "Bootstrap", "Tailwind", "JavaScript"],
  },
  {
    id: "02",
  ...
  return (
    <section id="experience" style={{
      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 2.5rem" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "4rem" }}>
          ...
          <div>
            <p style={{
              ...
              fontSize: "0.68rem", letterSpacing: "0.22em", color: "#534ab7",
              textTransform: "uppercase", marginBottom: "0.3rem",
            }}>What I've built</p>
            <h2 style={{
              fontFamily: "'Fraunces',serif", fontSize: "2.4rem",
              fontWeight: 900, color: "#111", letterSpacing: "-0.02em", lineHeight: 1.1,
            }}>Technical<br /><em style={{ fontStyle: "italic", color: "#534ab7" }}>Experience</em></h2>
          </div>
        </div>

        {/* Top 2 large */}
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem", marginBottom: "1.5rem" }} className="dv-proj-top">
          {experience.slice(0, 2).map(({ id, title, color, bg, items, tags }) => (
            <div key={id} style={{
              border: "1.5px solid #e0dbd4", padding: "2rem",
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "1.5rem" }}>
                <span style={{
                  ...
                  fontWeight: 900, color: bg, lineHeight: 1,
                }}>{id}</span>
                <h3 style={{
                  fontFamily: "'Space Grotesk',sans-serif", fontWeight: 700,
                  fontSize: "1rem", color: "#111", textAlign: "right", lineHeight: 1.3,
                  maxWidth: "160px",
                }}>{title}</h3>
              </div>
        ...
        {/* Bottom 2 */}
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem" }} className="dv-proj-bot">
          {experience.slice(2).map(({ id, title, color, bg, items, tags, featured }) => (
            <div key={id} style={{
              border: "1.5px solid #e0dbd4", padding: "2rem",
              borderTop: `4px solid ${color}`,
            }}>
                ...
                <div style={{ textAlign: "right" }}>
                  {featured && (
                    <p style={{
                      ...
                      color: color, background: bg, padding: "3px 8px",
                      display: "inline-block", marginBottom: "0.3rem",
                    }}>Featured Project</p>
                  )}
                  <h3 style={{
                    fontFamily: "'Space Grotesk',sans-serif", fontWeight: 700,
                    fontSize: "1rem", color: "#111", lineHeight: 1.3,
                  }}>{featured || title}</h3>
                </div>
              </div>
              <ul style={{ listStyle: "none", padding: 0, marginBottom: "1.5rem" }}>
